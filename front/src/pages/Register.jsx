...
const Register = () => {
    const [formData, setFormData] = useState({ name: '', surname: '', email: '', phone: '', password: '', password_confirmation: '', accept: false });
        ...
        <div className="min-h-screen flex flex-col justify-between bg-white">
            <div className="flex flex-col items-center pt-10">
                ...
                <div className="w-full max-w-2xl mx-auto mt-2">
                    ...
                    <p className="text-gray-500 text-center mb-8">Inscrivez-vous pour accéder à votre espace personnel et gérer vos rendez-vous médicaux</p>
