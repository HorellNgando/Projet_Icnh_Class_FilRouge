        ...
        <div className="container mx-auto px-4 py-8">
            <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800">Notes Médicales</h2>
                    <div className="flex space-x-4">
                        ...
                        <button
                            onClick={() => navigate('/dashboard/admin/notes/create')}
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {currentNotes.map((note) => (
                                <tr 
                                    ...
                                    onClick={() => navigate(`/dashboard/admin/notes/${note.id}`)}
                                >
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                            ...
                                            note.type === 'observation' ? 'bg-green-100 text-green-800' :
                                            note.type === 'suivi' ? 'bg-yellow-100 text-yellow-800' :
                        ...
                        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                            <div>
                                <p className="text-sm text-gray-700">
                                    Affichage de <span className="font-medium">{indexOfFirstNote + 1}</span> à{' '}
                                    <span className="font-medium">
                                        {Math.min(indexOfLastNote, filteredNotes.length)}
                                    </span>{' '}
                                    sur <span className="font-medium">{filteredNotes.length}</span> résultats
                                </p>
                            </div>
                            <div>
